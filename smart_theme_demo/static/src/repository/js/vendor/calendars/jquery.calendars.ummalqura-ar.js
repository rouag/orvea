...
(function ($) {
	$.calendars.calendars.ummalqura.prototype.regionalOptions['ar'] = {
		...
		dayNamesMin: ['ح', 'ن', 'ث', 'ر', 'خ', 'ج', 'س'], //dayNamesMin: ['الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'],
		dayNamesShort: ['ح', 'ن', 'ث', 'ر', 'خ', 'ج', 'س'], //dayNamesShort: ['الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'],
