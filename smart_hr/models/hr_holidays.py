...
#                 if eid.date_from <= holiday.date_from <= eid.date_to or \
#                         eid.date_from <= holiday.date_to <= eid.date_to or \
#                         holiday.date_from <= eid.date_from <= holiday.date_to or \
#                         holiday.date_from <= eid.date_to <= holiday.date_to:
