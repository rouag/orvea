...
class HrCardReport(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(HrCardReport, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
            'get_hijri_date': self._get_hijri_date,
        })
...
class ReportHrCard(osv.AbstractModel):
    _name = 'report.smart_hr.hr_emp_card_report'
    _inherit = 'report.abstract_report'
    _template = 'smart_hr.hr_emp_card_report'
    _wrapped_report_class = HrCardReport 


class HrSuspension(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(HrSuspension, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
            'get_hijri_date': self._get_hijri_date,
        })
...
class ReportHrSuspension(osv.AbstractModel):
    _name = 'report.smart_hr.hr_suspension_report'
    _inherit = 'report.abstract_report'
    _template = 'smart_hr.hr_suspension_report'
    _wrapped_report_class = HrSuspension
