...
class SalaryGridDetailReward(models.TransientModel):
    _name = 'wiz.grid.detail.reward'
...
class SalaryGridDetailIndemnity(models.TransientModel):
    _name = 'wiz.grid.detail.indemnity'
