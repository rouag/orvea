...
class SalaryGridDetail(models.Model):
    ...
    retirement = fields.Float(string='نسبة المحسومللتقاعد')
    retirement_amount = fields.Float(string='المبلغ المحسومللتقاعد', readonly=1, compute='_compute_retirement_amount', store=True)
